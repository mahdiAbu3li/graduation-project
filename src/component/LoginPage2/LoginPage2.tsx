  ...
  return (
    ...
    <linearGradient id="grad3" x1="-15%" y1="54%" x2="89%" y2="91%">
      ...
      <stop offset="100%" style={{"stopColor":" rgba(28,130,113,1)" , "stopOpacity":1 }} />
              ...
              <svg
                viewBox="135.796 4.122 864.413 514.03"
                xmlns="http://www.w3.org/2000/svg"
              >
                <defs>
                  <linearGradient
            ...
            <div className={styles.container_card_background}>
              ...
              <div className={styles.right}>
                ...
                <h3>
                  iiiif you new here click here to create a new account to log
                  onto the sit
                </h3>
          ...
          <div className={styles.container_card}>
            <div className={styles.container_card_background}>
              <div className={styles.right}>
                ...
                <h3>
                  iiiiif you new here click here to create a new account to log
                  onto the sit
                </h3>
                <button onClick={handleFlip}>Sign up</button>
                <img src={login} alt="" />
